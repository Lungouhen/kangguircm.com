...
<div class="p-6">
    <div class="max-w-4xl mx-auto">
        ...
        <!-- Form -->
        <form action="{{ route('admin.cms.posts.update', $post->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="border-t pt-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="url" name="canonical_url" id="canonical_url" value="{{ old('canonical_url', $post->canonical_url) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="https://example.com/preferred-url">
                    </div>
                    <label class="flex items-center gap-2"><input type="checkbox" name="noindex" value="1" @checked(old('noindex', $post->noindex))> Prevent search engines from indexing this post</label>
                    <div>
