...
<div class="page-header">
    ...
    <div class="page-header__actions">
        <a href="{{ route('admin.cms.posts.index') }}" class="btn btn--outline">
            ← Back to Posts
        </a>
    </div>
</div>
...
<div class="card">
    <div class="card__body">
        <form action="{{ route('admin.cms.posts.store') }}"
              method="POST"
            ...
            <div class="form__group">
                <label for="canonical_url" class="form__label">Canonical URL</label>
                <input type="url" id="canonical_url" name="canonical_url" value="{{ old('canonical_url') }}" class="form__input" placeholder="https://example.com/preferred-url">
                <small class="form__help">Leave blank to use this post's URL.</small>
            </div>
            <div class="form__group">
                <label><input type="checkbox" name="noindex" value="1" @checked(old('noindex'))> Prevent search engines from indexing this post</label>
            </div>
