...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white shadow rounded-lg p-8 border-t-4 border-blue-600">
        <div class="text-center mb-6"><h1 class="text-2xl font-bold text-gray-900">PAYSLIP</h1><p class="text-gray-500">{{ $payroll->period }}</p></div>
        <div class="grid grid-cols-2 gap-4 mb-6 border-b pb-4">
            ...
            <div><span class="font-medium">Employee ID:</span> {{ $payroll->employee->employee_id }}</div>
        ...
        <table class="w-full mb-6">
            ...
            <tbody>
                <tr class="border-b"><td class="py-2">Base Salary</td><td class="text-right">${{ number_format($payroll->base_salary, 2) }}</td></tr>
                ...
                <tr class="border-b"><td class="py-2 font-bold">Total Earnings</td><td class="text-right font-bold">${{ number_format($payroll->base_salary + $payroll->allowances, 2) }}</td></tr>
            </tbody>
        </table>
        <table class="w-full mb-6">
        ...
        <div class="border-t-2 pt-4"><div class="flex justify-between items-center"><span class="text-xl font-bold">Net Pay</span><span class="text-2xl font-bold text-blue-600">${{ number_format($payroll->net_pay, 2) }}</span></div></div>
